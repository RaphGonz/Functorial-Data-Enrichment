...
def main(input_path: str, output_dir: str) -> None:
    ...
    response = chat(
        ...
        format=TopicClassificationOutput.model_json_schema(),
    )

    topic = TopicClassificationOutput.model_validate_json(response.message.content)

    out_file = output_dir / "topic.json"
    out_file.write_text(
